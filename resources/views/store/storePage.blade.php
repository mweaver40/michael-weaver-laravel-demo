...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-6 col-bottom" style="padding-top:10px" >
        ...
        <div class="col-md-6 col-bottom">
            <div class="col-md-6 col-bottom">
                <img  src="{{ URL::to('/') }}/images/sarah.jpg" alt="sarah" style="padding-top:10px; width:100%">  
            </div>
            <div class="col-md-6 co-bottom">
                <img src="{{ URL::to('/') }}/images/redsea.jpg" alt="redsea" style="padding-top:10px; width:100%">  
            </div>
        </div>
    </div>
